data "helm_repository" "stable" {
  ...
  # TODO Cyclic depedency on apply/destroy - may be related to main.tf:provider.helm dependency on helm init client 
...
# TODO Cyclic dependencies on apply/destroy
